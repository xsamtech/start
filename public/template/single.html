        					...
        					<div class="col-md-9 col-sm-8 col-xs-12 articles-container single-post">
        						<article class="article">
        							...
        							<figure class="article-media-container">
        								<img src="images/blog/post1-large.jpg" alt="blog post">
        							</figure>
        							
        							<h2>Etiam laoreet sem eget eros rhoncus.</h2>
        							...
        							<div class="article-author clearfix">
        								...
        								<div class="article-author-details">
        									...
        									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad voluptas obcaecati nam tempore nostrum aliquid fuga numquam est quam mollitia cupiditate voluptatum animi aliquam nesciunt nisi doloremque minima amet at!</p>
        							...
        							<div class="comments">
        								...
        								<ul class="comments-list">
											<li>
												<div class="comment clearfix">
													<figure>
														<img src="images/blog/user1.jpg" alt="Comment Author">
													</figure>
													<div class="comment-details">
														<div class="comment-title">
															Duis tincidunt augue purus
														</div><!-- End .comment-title -->
														<div class="comment-meta-container">
															<a href="#">Anna Retallick</a>
															<span>12.07.2013</span>
															<a href="#" class="replay-button">Replay</a>
														</div><!-- End .comment-meta-container -->
														<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam consequuntur ratione obcaecati non consequatur sed iure eligendi nobis? Eligendi enim ut non ducimus..</p>
												...
												<ul class="children">
													<li>
														<div class="comment clearfix">
															<figure>
																<img src="images/blog/user2.jpg" alt="Comment Author">
															</figure>
															<div class="comment-details">
																<div class="comment-title">
																	Phasellus interdum risus at ullamcorper
																</div><!-- End .comment-title -->
																<div class="comment-meta-container">
																	<a href="#">Tom Retallick</a>
																	<span>14.07.2013</span>
																	<a href="#" class="replay-button">Replay</a>
																</div><!-- End .comment-meta-container -->
																<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam consequuntur ratione obcaecati non consequatur sed iure eligendi nobis? Eligendi enim ut non ducimus blanditiis rerum.</p>
															</div><!-- End .comment-details -->
														</div><!-- End .comment -->
													</li>
        								...
        								<h4 class="sub-title">Leave a reply</h4>
        							...
        							<form action="#" id="comment-form">
        								<div class="col-md-6 col-sm-6 col-xs-12">
											<div class="input-group">
												...
												<input type="text" name="comment-name" id="comment-name" required class="form-control input-lg" placeholder="Your Name">
											</div><!-- End .input-group -->
        									<div class="input-group">
												<span class="input-group-addon"><span class="input-icon input-icon-email"></span><span class="input-text">Email&#42;</span></span>
												<input type="email" name="comment-email" id="comment-email"  required class="form-control input-lg" placeholder="Your Email">
											</div><!-- End .input-group -->
        									<div class="input-group">
												<span class="input-group-addon"><span class="input-icon input-icon-subject"></span><span class="input-text">Subject&#42;</span></span>
												<input type="text" name="comment-subject" id="comment-subject"  required class="form-control input-lg" placeholder="Subject">
											</div><!-- End .input-group -->
...
fields are marked *</p>
        								...
        								<div class="col-md-6 col-sm-6 col-xs-12">
											<div class="input-group textarea-container">
												...
												<textarea name="comment-message" id="comment-message" class="form-control" cols="30" rows="6" placeholder="Your Comment"></textarea>
											</div><!-- End .input-group -->
