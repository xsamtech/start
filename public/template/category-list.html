        					...
        					<div class="col-md-9 col-sm-8 col-xs-12 main-content">
        						...
        						<div class="category-toolbar clearfix">
									<div class="toolbox-filter clearfix">
										...
										<div class="view-box">
											<a href="category.html" class="icon-button icon-grid"><i class="fa fa-th-large"></i></a>
											<a href="category-list.html" class="active icon-button icon-list"><i class="fa fa-th-list"></i></a>
										</div><!-- End .view-box -->
        						...
        						<div class="category-item-container category-list-container">
    								...
    								<div class="item item-list clearfix">
    									<div class="item-image-container">
											<figure>
												<a href="product.html">
													<img src="images/products/item5.jpg" alt="Phone 2" class="item-image">
													<img src="images/products/item5-hover.jpg" alt="Phone 2 Hover" class="item-image-hover">
												</a>
											</figure>
    										<div class="item-price-container">
    								...
    								<div class="item item-list clearfix">
    									<div class="item-image-container">
											<figure>
												<a href="product.html">
													<img src="images/products/item4.jpg" alt="Item 4" class="item-image">
													<img src="images/products/item4-hover.jpg" alt="Item 4 Hover" class="item-image-hover">
												</a>
											</figure>
    										<div class="item-price-container">
    								...
    								<div class="item item-list clearfix">
    									<div class="item-image-container">
											<figure>
												<a href="product.html">
													<img src="images/products/item3.jpg" alt="Item 3" class="item-image">
													<img src="images/products/item3-hover.jpg" alt="Item 3 Hover" class="item-image-hover">
												</a>
											</figure>
    										<div class="item-price-container">
												<span class="item-price">$99<span class="sub-price">.75</span></span>
