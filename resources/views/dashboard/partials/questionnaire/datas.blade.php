...
@if ($entity == 'question')
    ...
    @foreach ($assertions as $assertion)
                                    <li class="list-group-item clearfix">
                                        <a role="button" class="btn strt-btn-green p-0 float-end rounded-circle" title="@lang('miscellaneous.change')" data-bs-toggle="tooltip" style="width: 40px; height: 40; padding: 0.3rem 0.3rem 0.3rem 0.3rem;"><i class="bi bi-pencil"></i></a>
                                        <a role="button" class="btn btn-danger me-2 p-0 float-end rounded-circle" title="@lang('miscellaneous.delete')" data-bs-toggle="tooltip" style="width: 40px; height: 40; padding: 0.3rem 0.3rem 0.3rem 0.3rem;"><i class="bi bi-x-lg"></i></a>
