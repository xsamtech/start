...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!--! END: Bootstrap CSS-->
        <!--! BEGIN: Vendors CSS-->
        <link rel="stylesheet" type="text/css" href="{{ getApiURL() . '/template/admin/assets/vendors/css/vendors.min.css' }}" />
        <link rel="stylesheet" type="text/css" href="{{ getApiURL() . '/template/admin/assets/vendors/css/daterangepicker.min.css' }}" />
        <!--! END: Vendors CSS-->
        <!--! BEGIN: Custom CSS-->
            ...
            <div class="navbar-wrapper">
                <div class="m-header">
                    <a href="index.html" class="b-brand">
                        ...
                        <img src="{{ asset('assets/img/brand.png') }}" alt="" class="logo logo-lg" />
