                        ...
                        <div class="dropdown-menu dropdown-menu-start nxl-h-dropdown nxl-search-dropdown">
                            ...
                            <div class="search-items-wrapper">
                                ...
                                <div class="users-result px-4 py-2">
                                    <h4 class="fs-13 fw-normal text-gray-600 mb-3">@lang('miscellaneous.search_users') <span class="badge small bg-gray-200 rounded ms-1 text-dark">{{ count($members_req) }}</span></h4>
...
@endforelse
                                ...
                                <div class="file-result px-4 py-2">
                                    <h4 class="fs-13 fw-normal text-gray-600 mb-3">@lang('miscellaneous.search_sectors') <span class="badge small bg-gray-200 rounded ms-1 text-dark">{{ count($sectors_req) }}</span></h4>
...
@endforelse
                                ...
                                <div class="dropdown-divider my-3"></div>
                                <div class="file-result px-4 py-2">
                                    <h4 class="fs-13 fw-normal text-gray-600 mb-3">@lang('miscellaneous.search_categories') <span class="badge small bg-gray-200 rounded ms-1 text-dark">{{ count($categories_req) }}</span></h4>
