					...
					<div class="row">
						<div class="col-md-12">
							<div class="clearfix">
								...
								<button class="btn strt-btn-green pb-2" style="float: right; display: flex; align-items: center;" class="btn btn-primary" data-toggle="modal" data-target="#newServiceModal">
