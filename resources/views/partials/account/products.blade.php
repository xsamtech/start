						...
						<div class="col-md-12">
							<div class="clearfix">
								<header class="content-title" style="float: left;">
									<h1 class="title" style="margin-bottom: 5px;">@lang('miscellaneous.menu.account.product.title')</h1>
							...
							<ul id="portfolio-filter" class="clearfix">
								...
								<li><a class="active">@lang('miscellaneous.menu.account.product.title')</a></li>
