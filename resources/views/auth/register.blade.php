...
@section('app-content')
    ...
    @enderror
                                                    ...
                                                    <div class="input-group" style="margin-bottom: 10px; z-index: 5;">
                                                        ...
                                                        <input type="text" name="birthdate" class="form-control input-lg" placeholder="@lang('miscellaneous.ones_you_masculine') @lang('miscellaneous.nationality')">
                                                    </div><!-- End .input-group -->
                                                    ...
                                                    <div id="userGender" class="text-center">
                                                        ...
                                                        <label class="radio-inline">
                                                            <input type="radio" name="gender" id="gender1" value="M" checked><span class="text-muted">@lang('miscellaneous.gender1')</span>
                                                        </label>
                                                        <label class="radio-inline">
									...
									<div class="col-md-12">
                                        <fieldset>
											<h2 class="sub-title text-uppercase">CONTACT</h2>
    ...
    @enderror
                                                        ...
                                                        <div class="form-check" style="margin: 40px 0 20px 0;" onclick="checkTermsAccept();">
                                                            <input class="form-check-input" type="checkbox" id="termsAccept">
                                                            <label class="form-check-label" for="termsAccept" style="font-weight: normal;">@lang('miscellaneous.accept_terms')</label>
                                                        </div>

                                                        <button type="submit" id="registerNewUser" class="btn btn-custom-2 disabled" style="width: 300px; margin: 0 auto;">@lang('auth.register')</button>
            										</fieldset>
